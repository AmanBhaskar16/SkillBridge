...
const Dashboard = () => {
  ...
  return (
    <div className='min-h-screen'>
      {/* Navbar-Recruiter section*/}
      <div className='shadow py-4'>
        <div className='px-5 flex justify-between items-center'>
          <img onClick={e => navigate('/')} className='max-sm:w-32 cursor-pointer h-8' src={assets.logo} alt="" />
          <div className='flex items-center gap-3'>
            <p className='max-sm:hidden'>Welcome, Aman Bhaskar</p>
    ...
    {/* Sidebar */}
      <div className='inline-block min-h-screen border-r-2 border-r-gray-400'>
